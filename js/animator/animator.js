...
class Animator { 
  ...
  createCSSRule(property, value) {
   ...
   /**
	...
	transition(options) {
		return new SequenceWrapper(options, DomUtils, Prefix, CssUtils, Transition, Combo, Audio, this.tracker);
	}
   ...
   /**
	...
	animation(options) {
		return new SequenceWrapper(options, DomUtils, Prefix, CssUtils, Animation, Combo, Audio, this.tracker);
	}
